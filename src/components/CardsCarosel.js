...
const CardsCarosel = ({ location }) => {
    const [activeStep, setActiveStep] = useState(0);
  
    const maxSteps = location.locationImages.length; 
    
    const handleSingleImageTrasition = (direction) => {
        if(direction ==='next'){
          ...
          <MobileStepper
            ...
            nextButton={
              <Button
                size="small"
                sx={carouselDot}
                onClick={()=> handleSingleImageTrasition('next')}
            ...
            backButton={
              <Button
                size="small"
                sx={carouselDot}
                onClick={()=> handleSingleImageTrasition('back')}
